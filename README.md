...
**1. Интерфейс `IProduct`** - описывающий сущность товара
...
**2. Интерфейс `IOrder`** - описывающий сущность заказа
...
**3. Интерфейс `IOrderResult` ** - описывающий сущность результата созданного заказа
